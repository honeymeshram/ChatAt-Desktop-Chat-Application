...
import static chatat.application.Server.frame1;
import static chatat.application.Server.textarea1;
import javax.swing.*;
...
//         ImageIcon imageicon1 = new ImageIcon(ClassLoader.getSystemResource("chatat/application/icons/1.png"));
...
//         panel1.add(label6);
 ...
 JLabel label30 = new JLabel("ChatAt");
       ...
       // label3.setForeground(Color.WHITE);
        ...
        JLabel label3 = new JLabel("CLIENT (T)");
     ...
     public static  void main(String[] args){
          new Client().frame1.setVisible(true);
          
          try{
              socket1 = new Socket("127.0.0.1",1117);
